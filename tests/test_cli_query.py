...
class TestLsArgs:
    ...
    # spec: ticket-query requirement=list-tickets scenario=filter-by-assignee-short-form
    ...
    # spec: ticket-query requirement=list-tickets scenario=filter-by-tag-short-form
    def test_ls_tag_short_flag(self) -> None:
