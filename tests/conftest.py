...
def default_tickets_dir(tmp_path: Path) -> T.Iterator[str]:
    ...
    write_ticket(Ticket(id="link-0001", title="Fixture", links=["link-0002", "link-0003"]), tickets_path)
    write_ticket(Ticket(id="link-0002", title="Fixture", links=["link-0001", "link-0003"]), tickets_path)
    write_ticket(Ticket(id="link-0003", title="Fixture", links=["link-0001", "link-0002"]), tickets_path)
